...
| Plik | Zawartość |
|---|---|
| **[trudne miejsca — przewodnik](15-trudne-miejsca-przewodnik.md)** | Mapa całej części III: trzy mechanizmy, które powtarzają się we wszystkich trudnych pomiarach, **ranking trudności** rozdziałów, plan nauki, jak korzystać z symulatorów, słownik oznaczeń (DAR, PI, WNZ, VLF, PRPD, tg δ i pozostałe) oraz trzy wzory do zapamiętania |
| **[napięcia indukowane](16-napiecia-indukowane.md)** | Sprzężenie pojemnościowe i indukcyjne rozdzielone na dwa niezależne mechanizmy, **symulator napięcia indukowanego** w linii równoległej, dlaczego uziemienie jednostronne nie chroni i skąd bierze się napięcie na uziemionym z jednej strony odcinku, wpływ na pomiary, procedura postępowania |
...
| **[topologia i zasilanie zwrotne](23-topologia-i-zasilanie-zwrotne.md)** | Źródła napięcia, których nie widać na schemacie jednokreskowym: **symulator polowania na zasilanie zwrotne**, katalog źródeł w polu „wyłączonym" (potrzeby własne, przekładniki napięciowe od strony wtórnej, generacja rozproszona, baterie kondensatorów, indukcja), gdzie w pięciu zasadach jest realna trudność, blokady, **odległości i planowanie stanowiska pomiarowego**, lista kontrolna |
